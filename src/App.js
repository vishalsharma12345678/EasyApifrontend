...
import UploadReport from "./pages/leaderpage/UploadReport";
import UserTeams from "./components/Employees/UserTeams";
import Attendance from "./components/Employees/Attendance";
import AttendeceUpload from "./pages/attendence/attendeceUploading";
...
const App = () => {
  ...
  return loading ? (
    ...
    <Switch>
      ...
      <LeaderRoute exact path="/uploadReport">
        <UploadReport />
      </LeaderRoute>
      <AdminRoute exact path="/ShowReport">
        <ShowReport />
      </AdminRoute>
      <AdminRoute exact path="/admins">
        <Admins />
      </AdminRoute>
      <AdminRoute exact path="/attendenceUpload">
        <AttendeceUpload />
      </AdminRoute>
